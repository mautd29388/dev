...
if ( $current_active_theme->get('Author') == 'mTheme' ) {
	//require mTheme_PATH . 'custom-post-type.php';
	require mTheme_PATH . 'option-tree/ot-loader.php';
	require mTheme_PATH . 'shortcode/shortcode.php';
	require mTheme_PATH . 'menus/menu.php';
}