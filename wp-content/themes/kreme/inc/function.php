 ...
 * Options default
 * */
add_action ( 'load-themes.php', 'kreme_init_theme' );
function kreme_init_theme() {
	global $pagenow;
 ...
 * Theme Options ID
 */
add_filter('ot_options_id', 'kreme_ot_options_id');
function kreme_ot_options_id() {
 ...
 * @return bool|string
 */
function kreme_translateColumnWidthVC( $width ) {
